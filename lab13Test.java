...
public class lab13Test 
{
	...
	public void setUp() throws Exception 
	{
		...
		try
		{
			...
			ArrayList<Integer> tempArray = testData.get(0);
			for(int i = 0; i < tempArray.size(); i++)
			{
				expectedResult1[i] = tempArray.get(i);
			}
			...
			tempArray = testData.get(1);
			for(int i = 0; i < tempArray.size(); i++)
			{
				expectedResult2[i] = tempArray.get(i);
			}
			...
			tempArray = testData.get(2);
			for(int i = 0; i < tempArray.size(); i++)
			{
				expectedResult3[i] = tempArray.get(i);
			}
		}
		catch(Exception e)
		{
	...
	@Test
	void testGetDistinctGreatherThanFiveCount()
	{
